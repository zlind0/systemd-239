...
int seccomp_protect_sysctl(void) {
        ...
        SECCOMP_FOREACH_LOCAL_ARCH(arch) {
                ...
                if (IN_SET(arch, SCMP_ARCH_X32, SCMP_ARCH_AARCH64, SCMP_ARCH_LOONGARCH64, SCMP_ARCH_SW_64))
                        /* No _sysctl syscall */
                        continue;
...
#if defined(__x86_64__) || defined(__arm__) || defined(__aarch64__) || defined(__loongarch__) || defined(__sw_64__)
...
#if !defined(__i386__) && !defined(__x86_64__) && !defined(__powerpc__) && !defined(__powerpc64__) && !defined(__arm__) && !defined(__aarch64__) && !defined(__loongarch__) && !defined(__sw_64__)
#warning "Consider adding the right mmap() syscall definitions here!"
                ...
                if (!IN_SET(arch, SCMP_ARCH_LOONGARCH64, SCMP_ARCH_SW_64)){
